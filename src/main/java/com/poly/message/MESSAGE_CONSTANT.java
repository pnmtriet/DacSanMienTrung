...
public class MESSAGE_CONSTANT {
	...
	public String PHONE_EMPTY="Số điện thoại không được để trống!";
	public String ADDRESS_EMPTY="Nhập lại mật khẩu không được để trống!";
	public String LOGIN_WRONG="Bạn nhập sai tài khoản hoặc mật khẩu!";
}
